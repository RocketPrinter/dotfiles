...
parser.add_argument('--icon-playing', default='%{F#F0C674}%{F-}')
parser.add_argument('--icon-paused', default='%{F#F0C674}%{F-}')
parser.add_argument('--icon-stopped', default='%{F#F0C674}⏹%{F-}')
